...
export default function SearchTableOrders(props: { tableData: any }) {
  ...
  const columns = [
    columnHelper.accessor('quoteLoadNumber', {
      id: 'quoteLoadNumber',
      header: () => (
        <Text
    ...
    columnHelper.accessor('quoteCustomer', {
      id: 'quoteCustomer',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('quoteService', {
      id: 'quoteService',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('quotePickup', {
      id: 'quotePickup',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('quoteFrom', {
      id: 'quoteFrom',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('quoteDeliver', {
      id: 'quoteDeliver',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('quoteNeedWork', {
      id: 'quoteNeedWork',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('quoteService', {
      ...
      cell: (info) => (
        <Flex align="center">
          ...
          {/* Render the CreateQuote modal if isCreateQuoteOpen is true */}
          {isCreateQuoteOpen && (
            <CreateQuote onClose={handleCloseCreateQuote} />
          )}
  ...
  return (
    ...
    >
      ...
      <Table variant="simple" color="gray.500" mb="24px" size="sm" w="auto" maxWidth="100vw">
        <Thead>
            ...
            <Tr key={headerGroup.id}>
              {headerGroup.headers.map((header) => (
                <Th
                  ...
                  fontSize="sm" // Smaller font size for headers
                >
                  {header.isPlaceholder ? null : (
                    <Flex
                      justify="space-between"
                      align="center"
                      fontSize="sm" // Adjusting font size here as well
                    >
          ...
          {table.getRowModel().rows.map((row) => (
            <Tr px="20px" key={row.id}>
              {row.getVisibleCells().map((cell) => (
                <Td
                  key={cell.id}
                  fontSize="sm" // Smaller font size for table data
                  minW="75px" // Minimum width for cells to make the table more compact
                  borderColor={borderColor}
                  py="2" // Reduce vertical padding to make rows more compact
                >
...
function DebouncedInput({
  ...
  return (
    <Flex w="100%">
      ...
      {isCreateQuoteOpen && (
        <CreateQuote onClose={() => setIsCreateQuoteOpen(false)} />
      )}
      ...
      <ImportQuoteModal isOpen={isOpen} onClose={onClose} onFileUpload={handleFileUpload} />
    </Flex>
  );
}
