...
// Custom components
import ReceiptTable from 'views/admin/main/shipments/shippingDetails/components/ReceiptTable';
import tableDataReceipt from 'views/admin/main/shipments/shippingDetails/variables/tableDataReceipt';
