...
import Content from 'views/admin/main/shipments/shippingDetails/components/Content';
        ...
        >
          <Flex direction="column" color="white" h="100%" w="100%">
            <Text
              ...
              fontWeight="bold"
            >
              Shipment Number: 1002939211123
            </Text>
            <Text fontSize={{ base: 'md', md: 'xl' }} fontWeight="regular">
              Last Updated: July 27, 2022 at 09:44 AM
            </Text>
          </Flex>
          <Flex alignSelf="start" my={{ base: 'auto', md: '0px' }}>
            ...
            <Button
              as={Link}
              to="/admin/shipments/view-shipments"
              alignItems="center"
              justifyContent="center"
              bg="linear-gradient(293.45deg, #a570fa 0%, #ffffff 92.27%)"
              _hover={{
                bg: 'linear-gradient(293.45deg, #a570fa 0%, #ffffff 92.27%)',
              }}
              _focus={{
