...
import TextCellModal from 'views/admin/main/maintenance/buyingRates/components/TextCellModal';
...
export default function SearchTableOrders(props: { tableData: any }) {
  ...
  const columns = [
    ...
    columnHelper.accessor('originalTerminal', {
      id: 'originalTerminal',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('destinationTerminal', {
    ...
    columnHelper.accessor('costPerLb', {
      id: 'costPerLb',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('adminAmount', {
      id: 'adminAmount',
      header: () => (
        <Text
          justifyContent="space-between"
    ...
    columnHelper.accessor('carrierActions', {
      id: 'carrierActions',
      header: () => (
        <Text
          justifyContent="space-between"
      ...
      cell: (info) => <TextCellModal brandColor={brandColor} info={info} />,
    }),
  ];
...
function DebouncedInput({
  ...
  return (
    <>
      <Flex w="100%">
        <SearchBar flex={5} me={{ base: '10px', md: '20px' }} />
        <Select
          flex={1}
          fontSize="sm"
          id="edit_product"
